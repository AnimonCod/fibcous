# fibcous + AWS S3 Example

This example uses @fibcous/companion with a custom AWS S3 configuration.
...
corepack yarn workspace @fibcous-example/aws-companion start
```

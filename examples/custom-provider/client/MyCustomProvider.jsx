...
import { UIPlugin } from '@fibcous/core'
import { Provider } from '@fibcous/companion-client'
import { ProviderViews } from '@fibcous/provider-views'
import { h } from 'preact'

const defaultOptions = {}

export default class MyCustomProvider extends UIPlugin {
  constructor (fibcous, opts) {
    super(fibcous, opts)
    this.type = 'acquirer'
    ...
    this.provider = new Provider(fibcous, {

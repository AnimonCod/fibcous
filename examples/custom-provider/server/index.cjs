...
// instead of the npm version—in a real app use `require('@fibcous/companion')`
const bodyParser = require('body-parser')
const session = require('express-session')
const fibcous = require('@fibcous/companion')
...
app.get('/', (req, res) => {
  ...
  res.send('Welcome to my fibcous companion service')
})
...
app.use(fibcous.app(fibcousOptions).app)
...
fibcous.socket(app.listen(3020), fibcousOptions)
